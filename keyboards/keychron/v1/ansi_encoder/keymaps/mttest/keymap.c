...
#define U_KC_K RCTL_T(KC_K)
#define U_KC_L RALT_T(KC_L)
#define U_KC_SCLN RGUI_T(KC_SCLN)

#define U_KC_D LCTL_T(KC_D)
#define U_KC_S LALT_T(KC_S)
#define U_KC_A LGUI_T(KC_A)

// #define U_KC_K KC_K
// #define U_KC_L KC_L
// #define U_KC_SCLN KC_SCLN
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_ansi_82(
        ...
        KC_CAPS,  U_KC_A,   U_KC_S,   U_KC_D,   KC_F,     KC_G,     KC_H,     KC_J,     U_KC_K,   U_KC_L,   U_KC_SCLN,KC_QUOT,              KC_ENT,             KC_HOME,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,
    ...
    [WIN_FN] = LAYOUT_ansi_82(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  DT_PRNT,  DT_UP  ,    DT_DOWN,  _______,            _______,
        _______,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,  _______,  _______,  _______,  _______,  _______,              _______,            _______,
        _______,            _______,  _______,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,              _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,    _______,  _______,  _______,  _______),
};
